...
function App() {
  ...
  const projectImages = [
    "https://github.com/morelowelds/Home/blob/main/morelo_welds_soldadura_industrial_bogota_1.jpeg?raw=true",
    "https://github.com/morelowelds/Home/blob/main/morelo_welds_soldadura_industrial_bogota_2.jpeg?raw=true",
    "https://github.com/morelowelds/Home/blob/main/morelo_welds_soldadura_industrial_bogota_3.jpeg?raw=true",
    "https://github.com/morelowelds/Home/blob/main/morelo_welds_soldadura_industrial_bogota_4.jpeg?raw=true",
    "https://github.com/morelowelds/Home/blob/main/morelo_welds_soldadura_industrial_bogota_5.jpeg?raw=true",
    "https://github.com/morelowelds/Home/blob/main/morelo_welds_soldadura_industrial_bogota_6.jpeg?raw=true",
    "https://github.com/morelowelds/Home/blob/main/morelo_welds_soldadura_industrial_bogota_7.jpeg?raw=true",
    "https://github.com/morelowelds/Home/blob/main/morelo_welds_soldadura_industrial_bogota_8.jpeg?raw=true",
    "https://github.com/morelowelds/Home/blob/main/morelo_welds_soldadura_industrial_bogota_9.jpeg?raw=true",
    "https://github.com/morelowelds/Home/blob/main/morelo_welds_soldadura_industrial_bogota_10.jpeg?raw=true",
    "https://github.com/morelowelds/Home/blob/main/morelo_welds_soldadura_industrial_bogota_11.jpeg?raw=true",
    "https://github.com/morelowelds/Home/blob/main/morelo_welds_soldadura_industrial_bogota_12.jpeg?raw=true",
    "https://github.com/morelowelds/Home/blob/main/morelo_welds_soldadura_industrial_bogota_14.jpeg?raw=true"
  ];
  const clientLogos = [
    {
      src: "https://github.com/morelowelds/Home/blob/main/ecopetrol_logo.png?raw=true",
      alt: "Ecopetrol"
    },
    {
      src: "https://github.com/morelowelds/Home/blob/main/pepsico_logo.png?raw=true",
      alt: "Pepsico"
    },
    {
      src: "https://github.com/morelowelds/Home/blob/main/metrogas_logo.png?raw=true",
      alt: "Metrogas"
    },
    {
      src: "https://github.com/morelowelds/Home/blob/main/colflo.png?raw=true",
      alt: "Colflo"
    },
    {
      src: "https://github.com/morelowelds/Home/blob/main/pyd.png?raw=true",
      alt: "PYD"
    }
  ];
      ...
      <div className="min-h-screen bg-black text-white" ref={targetRef}>
          ...
          <div className="container mx-auto px-6 py-4">
            <div className="flex justify-between items-center">
              <div className="flex items-center gap-4">
                <img 
                  src="https://github.com/morelowelds/Home/blob/main/LOGO%20empresa%20de%20MORELO%20FINAL_Mesa%20de%20trabajo%201.png?raw=true"
        ...
        <section className="relative min-h-screen flex items-center pt-20">
          <div 
            ...
            style={{
              backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), url("${projectImages[0]}")`,
        ...
        <section className="py-20 bg-metallic-3">
          <div className="container mx-auto px-6">
            <h2 className="text-4xl font-bold text-center mb-16 bg-clip-text text-transparent bg-gradient-to-r from-white to-gray-400">
              Morelo Welds en Acción
            </h2>
            <div className="relative w-full max-w-4xl mx-auto rounded-2xl overflow-hidden shadow-2xl">
              <div className="aspect-w-16 aspect-h-9">
                <iframe
                  src="https://www.youtube.com/embed/DgYLdsbNWLM?si=ak635zGjXmyOf6M7"
                  title="Morelo Welds - Servicios de Soldadura"
